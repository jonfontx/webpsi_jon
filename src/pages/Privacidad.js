...
El usuario podrá en cualquier momento ejercitar los derechos de acceso, oposición, rectificación, cancelación, limitación y portabilidad reconocidos en el citado Reglamento (UE). El ejercicio de estos derechos puede realizarlo el propio usuario a través de email a: jlfontebasso@icloud.com o en la dirección: C/ Hespérides, 5, Puerta 62, C.P. 38630 - Arona (Santa Cruz De Tenerife).

El usuario manifiesta que todos los datos facilitados por él son ciertos y correctos, y se compromete a mantenerlos actualizados, comunicando los cambios a Jonatan Luis Fontebasso

Finalidad del tratamiento de los datos personales:

¿Con qué finalidad trataremos tus datos personales?

En Jonatan Luis Fontebasso , trataremos tus datos personales recabados a través del Sitio Web: jonatanfontebasso.com, con las siguientes finalidades:
...
La solicitud de información y/o la contratación de los servicios de Jonatan Luis Fontebasso , cuyos términos y condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.
...
Los datos no se comunicarán a ningún tercero ajeno a Jonatan Luis Fontebasso , salvo obligación legal.

Se han contratado servicios de hosting ubicados fuera del Espacio Económico Europeo, en EEUU, considerado un destino seguro para transferencias internacionales de datos, en virtud del Privacy Shield (Escudo de Privacidad).

Datos recopilados por usuarios de los servicios

En los casos en que el usuario incluya ficheros con datos de carácter personal en los servidores de alojamiento compartido, Jonatan Luis Fontebasso no se hace responsable del incumplimiento por parte del usuario del RGPD.

Derechos propiedad intelectual jonatanfontebasso.com

Jonatan Luis Fontebasso es titular de todos los derechos de autor, propiedad intelectual, industrial, "know how" y cuantos otros derechos guardan relación con los contenidos del sitio web jonatanfontebasso.com y los servicios ofertados en el mismo, así como de los programas necesarios para su implementación y la información relacionada.

No se permite la reproducción, publicación y/o uso no estrictamente privado de los contenidos, totales o parciales, del sitio web jonatanfontebasso.com sin el consentimiento previo y por escrito.

Propiedad intelectual del software

El usuario debe respetar los programas de terceros puestos a su disposición por Jonatan Luis Fontebasso , aún siendo gratuitos y/o de disposición pública.

Jonatan Luis Fontebasso dispone de los derechos de explotación y propiedad intelectual necesarios del software.
...
Para toda actuación que exceda del cumplimiento del contrato, el usuario necesitará autorización por escrito por parte de Jonatan Luis Fontebasso , quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y ficheros de los servidores propiedad de Jonatan Luis Fontebasso , asumiendo la responsabilidad civil y penal derivada de cualquier incidencia que se pudiera producir en los servidores y sistemas de seguridad como consecuencia directa de una actuación negligente o maliciosa por su parte.

Propiedad intelectual de los contenidos alojados

Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por Jonatan Luis Fontebasso y, en particular de:

La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.
La publicación o la transmisión de cualquier contenido que, a juicio de Jonatan Luis Fontebasso , resulte violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio.
...
El usuario indemnizará a Jonatan Luis Fontebasso por los gastos que generara la imputación de Jonatan Luis Fontebasso en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de defensa jurídica, incluso en el caso de una decisión judicial no definitiva.
...
Los servicios ofertados, excepto los servicios específicos de backup, no incluyen la reposición de los contenidos conservados en las copias de seguridad realizadas por Jonatan Luis Fontebasso , cuando esta pérdida sea imputable al usuario; en este caso, se determinará una tarifa acorde a la complejidad y volumen de la recuperación, siempre previa aceptación del usuario.

La reposición de datos borrados sólo está incluida en el precio del servicio cuando la pérdida del contenido sea debida a causas atribuibles a Jonatan Luis Fontebasso .

Comunicaciones comerciales

En aplicación de la LSSI. Jonatan Luis Fontebasso no enviará comunicaciones publicitarias o promocionales por correo electrónico u otro medio de comunicación electrónica equivalente que previamente no hubieran sido solicitadas o expresamente autorizadas por los destinatarios de las mismas.

En el caso de usuarios con los que exista una relación contractual previa, Jonatan Luis Fontebasso sí está autorizado al envío de comunicaciones comerciales referentes a productos o servicios de Jonatan Luis Fontebasso que sean similares a los que inicialmente fueron objeto de contratación con el cliente.
